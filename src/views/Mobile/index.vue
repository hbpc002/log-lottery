...
<template>
  <div class="flex flex-col min-h-screen bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 relative overflow-hidden">
    ...
    <div class="absolute inset-0 opacity-20">
      <div class="absolute top-10 left-10 w-64 h-64 bg-blue-400 rounded-full mix-blend-multiply filter blur-3xl animate-pulse"></div>
      <div class="absolute bottom-20 right-10 w-64 h-64 bg-pink-400 rounded-full mix-blend-multiply filter blur-3xl animate-pulse" style="animation-delay: 2s;"></div>
    </div>

    <!-- 头部 -->
    <div class="relative z-10 p-6 pb-4">
      <div class="text-center">
        <h2 class="text-2xl font-bold text-white drop-shadow-lg">发送弹幕</h2>
        <p class="text-white/80 text-sm mt-1">与大家一起互动吧</p>
      </div>
    </div>
